...
public class Tuteur {
    ...
    public void MettreAjourMessages() {
        message_Indice_Strat = "Pour avancer, tu dois appliquer la strategie dite "
                + _indiceStrat + ". Voici un petit rappel.";
        message_Indice_Coup = "Il y a une case ou un coup est jouable. Il s'agit de la case situee "
                + _indiceCoup + ".";
        message_Indice_Region = "Il y a une region ou au moins un coup est possible. Il s'agit de la region numero "
                + _indiceRegion + ".";
        message_Indice_Zone = "Il y a une zone ou au moins au coup est possible. Il s'agit de la partie "
                + _indiceZone + " de la grille.";

        message_Succes_1 = "Bravo ! Tu as applique pour la premiere fois "
                + _succesStrat + " avec succes !";
        message_Succes_2 = "Tu as encore une fois bien applique "
                + _succesStrat + " ! Bien joue !";
        message_Succes_3 = "Felicitation ! Je crois que tu as compris le principe de "
    ...
    public void Message_Indice() {
        if (_aDejaEuUnIndice == true) {
            ...
            int strategieUtilisable = _expert.strategieAJouer();
